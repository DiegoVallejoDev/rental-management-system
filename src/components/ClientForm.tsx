...
export function ClientForm({ onSave, onClose, clientToEdit }: ClientFormProps) {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
                <label htmlFor="address" className="text-sm font-medium text-gray-300">Address (Optional)</label>
            ...
            <div className="flex justify-end gap-4 pt-4">
                ...
                <button type="submit" className="bg-cyan-600 hover:bg-cyan-700 text-white font-bold py-2 px-4 rounded-md">Save Client</button>
            </div>
        </form>
    );
}